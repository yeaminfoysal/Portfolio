...
const Projects = () => {
    return (
        <div id='projects' className='py-20 text-center w-[70%] mx-auto'>
            ...
            <div className='flex flex-col mt-10 gap-16'>
                <div className='flex justify-between items-center text-left h-[500px]'>
                    <div className='flex-1 flex flex-col justify-center bg-gradient-to-r from-[#091020] to-[#09102061] p-20 rounded-s-2xl h-full'>
                ...
                <div className='flex justify-between items-center text-left h-[500px]'>
                    <div className='flex-1 flex flex-col justify-center bg-gradient-to-r from-[#201209] to-[#20180961] p-20 rounded-s-2xl h-full'>
                ...
                <div className='flex justify-between items-center text-left h-[500px]'>
                    <div className='flex-1 flex flex-col justify-center bg-gradient-to-r from-[#091720] to-[#09152061] p-20 rounded-s-2xl h-full'>
