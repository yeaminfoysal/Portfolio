...
const Banner = () => {
    return (
        <div id="home" className='section py-24 overflow-hidden'>
            <div className='grid grid-cols-1 xl:grid-cols-2 items-center justify-evenly mx-auto w-[95%] lg:w-[85%] bg-secondery px-[20px] py-10 lg:py-0 lg:px-[105px] rounded-2xl shadow-2xl'>
                <div className='font-secondery py-20'>
                    <p>Welcome to my world</p>
                    <h1 className='text-[60px] font-bold text-white'>Hi, I'm <span className='color-gradient'>Yeamin Foysal</span></h1>
                ...
                <div className='mx-auto text-ringt items-right'>
                    <img className='h-[550px] 2xl:h-[700px]' src={image} alt="" />
                </div>
            </div>
        </div>
    );
